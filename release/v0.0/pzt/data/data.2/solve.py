...
def main ():
  ...
  comsol = comsol[comsol['width (mm)'] == 2]
  comsol = comsol[comsol['length (mm)'] == 7]
  plt.figure (figsize=(12, 5))
  plt.subplot (1, 2, 1)
  plt.scatter (frequency, magnitude, label='Measured', color = 'gray', alpha=0.6)
  plt.semilogx (frequency_smooth, Mmodel, label='Circuit Model', linewidth=2, color = 'red', linestyle = '--')
  plt.plot (comsol['freq (Hz)'].to_numpy (), comsol['Impedance Magnitude (Ohms)'], label = 'COMSOL Model', lw = 2)
  ...
  plt.subplot (1, 2, 2)
  plt.scatter (frequency, phase, label='Measured', color = 'gray', alpha=0.6)
  plt.semilogx (frequency_smooth, Pmodel, label='Model', linewidth=2, color = 'red', linestyle = '--')
  plt.plot (comsol['freq (Hz)'].to_numpy (), comsol['Impedance Phase (rad)'], label = 'COMSOL Model', lw = 2)
  # if model.expected is not None:
